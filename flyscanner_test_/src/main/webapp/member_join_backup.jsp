...
<body>
<form action="joinConfirm.member" name="form1" id="form1" >
	이메일* <br>
		<input type="text" name="email" id="email" placeholder="사용가능한 이메일을 입력하세요."  > <br>
	...
	<input type="text" name="enamef" id="enamef">  <input type="text" name="enamel" id="enamel"> <br>	
	
	이름* <br>
		<input type="text" name="kname" id="kname" placeholder="한글 이름을 입력하세요."> <br>
	...
	핸드폰 번호* <br>
		...
		<option value="1">+1(캐나다)</option>
				...
				<!-- 번호 -->
		<input type="text" name="tel" id="tel" maxlength="14" > <br>  
